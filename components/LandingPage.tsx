...
const LandingPage: React.FC<LandingPageProps> = ({ onGrantAccess }) => {
  ...
  const handleApply = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Persist access
      localStorage.setItem('ai-capcut-access', 'true');
    }, 2000);
  };
          ...
          <div className="w-full max-w-md bg-[#111] border border-white/10 rounded-2xl shadow-2xl p-8 relative overflow-hidden">
            ...
            {applicationStep === 'form' && (
              <div className="animate-in slide-in-from-bottom-4 duration-300">
                ...
                <h3 className="text-2xl font-bold text-center mb-2">Apply for Access</h3>
                <p className="text-gray-400 text-center mb-8 text-sm">
                  AI CapCut is currently in private beta. Submit your email to verify eligibility.
                </p>
                ...
                <form onSubmit={handleApply} className="space-y-4">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-400 mb-1.5 uppercase">Intended Use</label>
                    <select className="w-full bg-[#222] border border-[#333] rounded-lg px-4 py-3 text-white focus:outline-none focus:border-purple-500 transition-colors">
                      <option>Content Creation (Personal)</option>
            ...
            {applicationStep === 'processing' && (
              <div className="text-center py-12 animate-in fade-in duration-300">
                 ...
                 <h3 className="text-xl font-bold mb-2">Verifying Eligibility...</h3>
                 <p className="text-gray-500">Checking waitlist status</p>
              </div>
            )}
            ...
            {applicationStep === 'success' && (
              <div className="text-center py-8 animate-in zoom-in-95 duration-300">
                ...
                <p className="text-gray-400 mb-8">
                  Congratulations! Your application has been instantly approved for the beta program.
                </p>
                <button 
                  onClick={handleEnterApp}
                  className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold py-3 rounded-lg hover:opacity-90 transition-opacity"
                >
                  Enter AI CapCut Studio
                </button>
              </div>
            )}
          </div>
